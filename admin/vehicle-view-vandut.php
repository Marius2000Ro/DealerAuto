...
<div class="container-fluid">
    ...
    <ol class="breadcrumb mb-4">
         ...
         <li class="breadcrumb-item">Vehicule vandute</li>
    </ol>
    <div class="row">
        ...
        <?php  include('message.php'); ?>
            <div class="card">
                    <div class="card-header">
                        ...
                        <a href="#vehicule"  class="btn btn-info">Vezi imagini vehicule vandute</a>
                    ...
                    <p class="text-center fs-3 fw-bold text-info">Descriere vehicule vandute</p>
                    <table id="myDataTable" class="table table-bordered ">
                            ...
                            <tbody>
                                ...
                                $query = "SELECT cars.*, category.name AS cname FROM cars, category  WHERE cars.category_id = category.id_category  AND cars.status != 'sters' AND cars.status !='Rezervat' AND cars.status ='Vandut'";
                        ...
                        <p id="vehicule" class="text-center fs-3 fw-bold text-info mt-5" >Imagini vehicule vandute</p>
                        ...
                        <thead>
                            ...
                            <tbody>
                                <?php
                                $query = "SELECT * FROM cars WHERE status !='sters' AND status !='Rezervat' AND status ='Vandut'";
                                $query_run = mysqli_query($con, $query);
