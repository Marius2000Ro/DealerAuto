...
<div class="container-fluid">
    ...
    <ol class="breadcrumb mb-4">
         ...
         <li class="breadcrumb-item">Vehicule rezervate</li>
    </ol>
    <div class="row">
        ...
        <?php  include('message.php'); ?>
            <div class="card">
                    <div class="card-header">
                        ...
                        <a href="#vehicule"  class="btn btn-info">Vezi imagini vehicule rezervate</a>
                    ...
                    <p class="text-center fs-3 fw-bold text-info">Descriere vehicule rezervate</p>
                    <table id="myDataTable" class="table table-bordered ">
                        ...
                        <p id="vehicule" class="text-center fs-3 fw-bold text-info mt-5" >Imagini vehicule rezervate</p>
